...
def test_gfp():
    gfp= FiniteField(37)
    verifytest(gfp.value(2).__pow__(16),  "0x9", "<2>^16")
    verifytest(gfp.value(16).__rpow__(2),  "0x9", "2^<16>")
    verifytest(gfp.value(1).__div__(4),  "0x1c", "<1>/4")
    verifytest(gfp.value(4).__rdiv__(1),  "0x1c", "1/<4>")
    verifytest(gfp.value(1).__eq__(38),  "True", "<1>==38")
    verifytest(gfp.value(38).__eq__(1),  "True", "1==<38>")
    verifytest(gfp.value(1).__ne__(38),  "False", "<1>!=38")
    verifytest(gfp.value(16).__mul__(16),  "0x22", "<16>*16")
    verifytest(gfp.value(16).__rmul__(16),  "0x22", "16*<16>")
